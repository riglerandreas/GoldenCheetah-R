...
path_ftp <- "C:/Users/rigle/Documents/Training/Laktat FTP/"
...
```{r}
ftp_data_raw <- read_csv2(str_c(path_ftp,"FTP.csv"))
...
update = FALSE  #If update = TRUE .. old aggregations will be overwritten, update = FALSE.. new date will be appended

old_aggregations <- read_rds("aggregations_result.rds")
...
if(!is_empty(aggregation_rides)){
  ...
  #Save the result:
  write_rds(aggregations_result, "aggregations_result.rds")
}
